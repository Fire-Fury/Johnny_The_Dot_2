...
Game.MainMenu.prototype = {
    ...
    create: function(game){
        ...
        this.createButton(game, "Quit", game.world.centerX, game.world.centerY + 152, 200, 50, function(){
            //this.state.start('Tutorial_1');
            MainMenuMethods.quit(game);
        });
    ...
    update: function(game){
        ...
        MainMenuMethods.checkForEnter(game);
    ...
    createButton: function(game, string, x, y, w, h, callback){
        ...
        var txt = game.add.bitmapText(button1.x, button1.y, "menuFont", string, 16);
